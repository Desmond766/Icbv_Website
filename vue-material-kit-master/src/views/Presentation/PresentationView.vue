      ...
      <div class="container">
        <div class="row">
          <div class="col-lg-7 text-center mx-auto position-relative">
            ...
            <p class="lead text-white px-5 mt-3" :style="{ fontWeight: '400', width:'100%' }">
              At Artemis, we are dedicated to using nature resources to create pure, plant-based products that
enrich everyday life with green energy. Guided by a deep respect for nature and backed by the
expertise of botanists, we unlock the full potential of plants and strive to offer products to promote
a natural, vitality, healthy, and eco-friendly lifestyle. By seamlessly combining the power of nature
and science, paving the way for a greener, healthier future.
            </p>
          </div>
        </div>
      </div>
