...
//image
import bg0 from "@/assets/img/logos/artemis-logo.jpg";
...
<template>
      ...
      <div class="container">
        <div class="row justify-content-center">
          <div class="col-lg-8 text-center mx-auto my-auto">
            <h1 class="text-white">
              We believe in <span class="text-white" id="typed"></span>
            </h1>
  ...
  <div class="card card-body shadow-xl mx-3 mx-md-4 mt-n6 bg-gradient-green">
    <Information />
    <AboutTeam />
    <!-- <Featuring />
    <Newsletter /> -->
